...
class VxRail():
    ...
    def init_cluster(self, config_json):
        ...
        try:
            ...
            LOGGER.error('Exception %s. Cannot connect to VxRail Manager %s.', e, self.vxm_ip)
...
def main():
    ...
    if validation_status == 'COMPLETED':
        ...
        module.fail_json(msg="Validation Task failed. Check Log /tmp/cluster-init.log for details")
    ...
    if init_status == 'COMPLETED':
        ...
        module.fail_json(msg="The VxRail Initializaiton Task failed. See /tmp/cluster-init.log for detials")
