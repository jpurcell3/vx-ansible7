...
class VxRail():
    def __init__(self):
        ...
        self.vcsa_tgt = module.params.get('vcsa_tgt')
    ...
    def intvc_json(self):
        ...
        migration['target_psc_host'] = {'name': self.vcsa_tgt, 'user' : {'username' : self.vcroot, 'password' : self.vcrootpasswd}}
        migration['temporary_ip_settings'] = {"gateway": self.gw, "netmask": self.mask, "tempIpVerified": 'true', "temporaryIp": self.tmpip, "temporary_ip": self.tmpip}
        vcenter_dict = {}
